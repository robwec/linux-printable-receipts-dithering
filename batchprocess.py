...
def justpyclaheditherit_csharpwrites(infolder, file, outfolder, pycoloroption, cscoloroption):
    ...
    edited_image = mainthing(infolder + "\\" + file, cscoloroption, writeimage = False, scaletype = False)
...
def justpyclaheditherit_cpp(infolder, file, outfolder, pycoloroption, cscoloroption, mycpplib, size = "receipt"):
    edited_image = mainthing(infolder + "\\" + file, cscoloroption, writeimage = False, scayletype = (size == "fourbysix"))
...
def cmdlinemain_cpp(imagename, colortype = "graycucuu", size = "fourbysixlabel"):
    clahe_image = mainthing(imagename, colortype, writeimage = False, scaletype = size)
